...
function AuthProvider({ children }) {
    ...
    const fetchUserData = async (firebaseUser)=>{
        try {
            console.log("[v0] 🔍 Fetching user data for UID:", firebaseUser.uid);
            console.log("[v0] 🔍 Email:", firebaseUser.email);
            const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "usuarios", firebaseUser.uid);
            console.log("[v0] 🔍 Firestore path:", `usuarios/${firebaseUser.uid}`);
            ...
            if (userDoc.exists()) {
                ...
                console.log("[v0] ✅ Documento encontrado en Firestore:");
                console.log("[v0] 📄 Raw data:", JSON.stringify(userData, null, 2));
                console.log("[v0] 👤 Nombre:", userData.nombre);
                console.log("[v0] 🎭 Rol:", userData.rol);
                console.log("[v0] 📧 Email:", userData.email);
                console.log("[v0] 🔑 UID del documento:", userDoc.id);
                return {
                ...
                console.error("[v0] ❌ NO se encontró documento en Firestore para UID:", firebaseUser.uid);
                console.error("[v0] ❌ Verifica que el usuario exista en la colección 'usuarios'");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], async (firebaseUser)=>{
            if (firebaseUser) {
                ...
                setUser(userData);
                console.log("[v0] 🎯 Estado final del usuario:");
                console.log("[v0] 📧 Email:", userData?.email);
                console.log("[v0] 🎭 Rol:", userData?.rol);
                console.log("[v0] 👤 Nombre:", userData?.nombre);
            } else {
                setUser(null);
                console.log("[v0] ⚠️ No hay usuario autenticado");
            }
            setLoading(false);
        });
        return ()=>unsubscribe();
    ...
    const signUp = async (email, password, userData)=>{
        try {
            ...
            const newUserData = await fetchUserData(userCredential.user);
            setUser(newUserData);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5e67fbad._.js.map